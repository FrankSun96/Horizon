<%@ Page Language="C#" AutoEventWireup="true" CodeFile="videoHome.aspx.cs" Inherits="videoHome" %><!DOCTYPE html>
         ...
         <div id="content0">
              ...
              <div id="gridView"> 
                 <asp:GridView ID="UserGridView" runat="server"  AutoGenerateColumns="false" Width="800px" style="border:1px solid #ccc;  background: rgba(250,250,250,0.4);"  ShowHeader="false" GridLines="Horizontal"> 
                    <Columns> 
                    <asp:TemplateField HeaderText="VideoName"> 
                    <ItemTemplate> 
                         <div id="name"><asp:Label ID="videoTitle" runat="server" Text='<%#Eval("VideoName") %>'></asp:Label></div>
                    </ItemTemplate> 
                    </asp:TemplateField> 
                    <asp:TemplateField HeaderText="CoverImg"> 
                    <ItemTemplate> 
                       <div id="images"><a runat="server" href='<%#"videos.aspx?videoID="+Eval("videoID") %>'><asp:Image ID="DisplayImg" runat="server"  ImageUrl='<%#Eval("CoverImg") %>'  style="width:200px;height: 100px"/> </a></div> 
                    </ItemTemplate> 
                    </asp:TemplateField> 
                    </Columns> 
                    </asp:GridView> 
